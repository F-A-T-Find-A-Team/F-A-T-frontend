...
  return (
    <>
      {isSign ? <SignPage setIsSign={setIsSign} setisLogin={setisLogin} setAccount={setAccount}/>:<LoginPage setIsSign={setIsSign} setisLogin={setisLogin}/>}
    </>
  )
}
// 로그인페이지
...
      <div id="Login-leftside"> {/*로그인화면 왼쪽(녹색)*/}
        <h1>F.A.T.</h1>
        <div>
...
function SignPage({setIsSign, setisLogin, setAccount}) {
...
  const handlePhotoClick = () => { //프로필 이미지 설정
...
              <button className={jungongSelect.includes("FE") ? "active" : ""} onClick={()=> {setJungongSelect("FE")}} type='button'>FE</button>
              <button className={jungongSelect.includes("BE") ? "active" : ""} onClick={()=> {setJungongSelect("BE")}} type='button'>BE</button>
              <button className={jungongSelect.includes("EM(FW)") ? "active" : ""} onClick={()=> {setJungongSelect("EM(FW)")}} type='button'>EM(FW)</button>
              <button className={jungongSelect.includes("EM(HW)") ? "active" : ""} onClick={()=> {setJungongSelect("EM(HW)")}} type='button'>EM(HW)</button>
              <button className={jungongSelect.includes("Flutter") ? "active" : ""} onClick={()=> {setJungongSelect("Flutter")}} type='button'>Flutter</button>
              <button className={jungongSelect.includes("android") ? "active" : ""} onClick={()=> {setJungongSelect("android")}} type='button'>android</button>
              <button className={jungongSelect.includes("iOS") ? "active" : ""} onClick={()=> {setJungongSelect("iOS")}} type='button'>iOS</button>
              <button className={jungongSelect.includes("UI") ? "active" : ""} onClick={()=> {setJungongSelect("UI")}} type='button'>UI/UX</button>
              <button className={jungongSelect.includes("Game") ? "active" : ""} onClick={()=> {setJungongSelect("Game")}} type='button'>Game</button>
              <button className={jungongSelect.includes("security") ? "active" : ""} onClick={()=> {setJungongSelect("security")}} type='button'>security</button>
              <button className={jungongSelect.includes("AI") ? "active" : ""} onClick={()=> {setJungongSelect("AI")}} type='button'>AI</button>
            </div>
          </div>
          
...
        {leftsideChose === "탐색" ? <SearchPage setLeftsideChose={setLeftsideChose} pjList={pjList} setClickedPj={setClickedPj} renderUserProfileImage={renderUserProfileImage} account={account}/> : ""}
          {leftsideChose === "프젝자세히" ? <ProjectMore clickedPj={clickedPj} setClickedPj={setClickedPj} setLeftsideChose={setLeftsideChose} account={account} renderUserProfileImage={renderUserProfileImage}/> : ""}
        {leftsideChose === "프로젝트 생성" ? <PjcreatePage setLeftsideChose={setLeftsideChose} pjList={pjList} setPjList={setPjList} account={account}/> : ""}
        {leftsideChose === "채팅" ? <ChatPage/> : ""}
        {leftsideChose === "AI 팀원 추천" ? <TeamRPage/> : ""}
        {leftsideChose === "마이페이지" ? <MyPage/> : ""}
      </div>
    </div>
  )
}
...
            <button className={jungongSelect.includes("FE") ? "active" : ""} onClick={()=> {Jungong_click("FE")}}>FE</button>
            <button className={jungongSelect.includes("BE") ? "active" : ""} onClick={()=> {Jungong_click("BE")}}>BE</button>
            <button className={jungongSelect.includes("EM(FW)") ? "active" : ""} onClick={()=> {Jungong_click("EM(FW)")}}>EM(FW)</button>
            <button className={jungongSelect.includes("EM(HW)") ? "active" : ""} onClick={()=> {Jungong_click("EM(HW)")}}>EM(HW)</button>
            <button className={jungongSelect.includes("Flutter") ? "active" : ""} onClick={()=> {Jungong_click("Flutter")}}>Flutter</button>
            <button className={jungongSelect.includes("android") ? "active" : ""} onClick={()=> {Jungong_click("android")}}>android</button>
            <button className={jungongSelect.includes("iOS") ? "active" : ""} onClick={()=> {Jungong_click("iOS")}}>iOS</button>
            <button className={jungongSelect.includes("UI") ? "active" : ""} onClick={()=> {Jungong_click("UI")}}>UI/UX</button>
            <button className={jungongSelect.includes("Game") ? "active" : ""} onClick={()=> {Jungong_click("Game")}}>Game</button>
            <button className={jungongSelect.includes("security") ? "active" : ""} onClick={()=> {Jungong_click("security")}}>security</button>
            <button className={jungongSelect.includes("AI") ? "active" : ""} onClick={()=> {Jungong_click("AI")}}>AI</button>
          </div>
...
          <button id='pj-cancel' onClick={()=>{setLeftsideChose("탐색");}}>취소</button>
          <button id='pj-submit' onClick={PjAddSubmit}>프로젝트 생성하기</button>
        </div>
      </div>
    </div>
  )
...
              {clickedPj.pjPerson.map((person, i) => (
...
          </div>
            ...
            <div id='mright-bottom'>
              {account === clickedPj.pjPerson[0] ? <PmExcuseButton/> : ""}
            </div>
        </div>
      </div>
    </div>
...
  const [isLogin, setisLogin] = useState(false); //로그인 기능 추가전 임시
  //const [isLogin, setisLogin] = useState(token ? true : false); //로그인 기능 생기면 이걸로
